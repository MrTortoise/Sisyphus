...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            var featureInfo = new TechTalk.SpecFlow.FeatureInfo(
                ...
                "CharacterBrowser",
                "In order to view a story from a character centric perspective or just explore a c"
                + "haracter\r\nAs a consumer \r\nI want to select and view a character to see its histo" + "ry",
...
#line 7
            testRunner.Given(
                "I have created a test database called \"characterBrowserTest\"",
                ((string)(null)),
...
#line hidden
            var table3 = new TechTalk.SpecFlow.Table(new string[] { "name", "Description", "Outcomes", "Places" });
            table3.AddRow(
                new string[]
                { "testEvent", "a test event to show how things work", "passed, failed, war", "testPlace,testPlace2" });
            table3.AddRow(new string[] { "StoryStart", "the start of the story", "started", "testPlace,testPlace2" });
#line 17
...
#line hidden
        ...
        public virtual void OpenCharacterBrowserAndLookAtCharacters()
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo(
                "Open character browser and look at characters",
                ((string[])(null)));
#line 25
...
#line 26
            testRunner.Given(
                ...
                "Given ");
#line hidden
            var table5 = new TechTalk.SpecFlow.Table(new string[] { "name", "backstory", "race", "sex", "place" });
            table5.AddRow(new string[] { "jim", "none", "foot", "rarley", "somewhere" });
            table5.AddRow(new string[] { "jim2", "none", "foot", "rarley", "somewhere" });
            table5.AddRow(new string[] { "jim3", "none", "foot", "rarley", "somewhere" });
            table5.AddRow(new string[] { "jim4", "none", "foot", "rarley", "somewhere" });
#line 27
            testRunner.Then(
                "I expect the character browser to contain the following characters",
                ((string)(null)),
                table5,
                "Then ");
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo(
                "Open a specific character from the browser",
                ((string[])(null)));
#line 34
            this.ScenarioSetup(scenarioInfo);
#line 6
...
#line 36
            testRunner.When(
                "I select the character \"jim\" in the character browser",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "When ");
#line 37
            testRunner.Then(
                "I expect to get the \"CharacterInformation\" view",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "Then ");
#line 38
            testRunner.And(
                "I expect the chatacter \"jim\" to be the CharacterInformation views subject",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "And ");
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo(
                "View a specific characters involvement in events",
                ((string[])(null)));
#line 40
            this.ScenarioSetup(scenarioInfo);
#line 6
...
#line 44
            testRunner.When(
                "I select view events in the character browser",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "When ");
#line 45
            testRunner.Then(
                "I expect to see the events browser",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "Then ");
#line hidden
            var table6 = new TechTalk.SpecFlow.Table(new string[] { "name" });
            table6.AddRow(new string[] { "testEvent" });
#line 46
...
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo(
                "Add characters to a following list",
                ((string[])(null)));
#line 50
            this.ScenarioSetup(scenarioInfo);
#line 6
