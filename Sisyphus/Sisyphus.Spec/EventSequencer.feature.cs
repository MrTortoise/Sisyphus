...
#line hidden
        ...
        public virtual void OpenEventSequencerAndSelectAnEvent()
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo(
                "Open event sequencer and select an event",
                ((string[])(null)));
#line 26
...
#line 28
            testRunner.When(
                "I select the event \"testEvent\"",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "When ");
#line 29
            testRunner.Then(
                "I expect the event sequencer to have the event \"testEvent\" selected",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "Then ");
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo(
                "Open the event editor with the correct event",
                ((string[])(null)));
#line 31
            this.ScenarioSetup(scenarioInfo);
#line 7
...
#line 35
            testRunner.Then(
                "I expect to get the \"EventEditor\" view",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "Then ");
#line 36
            testRunner.And(
                "I expect the event editor to have the event \"testEvent\" selected",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "And ");
#line hidden
        ...
        public virtual void SelectAStoryEventAndChooseToChainAnotherStoryEventFromIt()
        {
            var scenarioInfo =
                new TechTalk.SpecFlow.ScenarioInfo(
                    "Select a story event and choose to chain another story event from it",
                    ((string[])(null)));
#line 38
            this.ScenarioSetup(scenarioInfo);
#line 7
...
#line 41
            testRunner.When(
                "I select the event \"testEvent2\" to chain and click chain event",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "When ");
#line 42
            testRunner.Then(
                "I expect the event \"testEvent2\" to be chained from event \"testEvent\"",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "Then ");
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute(
            "Select a decision event, choose an outcome and assign a story event to it")]
...
#line 46
            testRunner.And(
                "I select the event \"testEvent3\"",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "And ");
#line 47
            testRunner.When(
                "I select the outcome \"passed\", story event \"testEvent\" and click chain",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "When ");
#line 48
            testRunner.Then(
                "I expect the event \"TestEvent\" to be chained from the event \"testEvent3\"",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "Then ");
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo(
                "Fail to chain a decision event to a decision event",
                ((string[])(null)));
#line 50
            this.ScenarioSetup(scenarioInfo);
#line 7
...
#line 53
            testRunner.Then(
                "I expect an exception when I select the outcome \"passed\", story event \"testEvent4"
                + "\" and click chain",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "Then ");
